...
import avatarDefault from "../../../public/assets/avatar-removebg-preview.png";
  ...
  return (
      ...
      </div>
    {
      user.role === "admin" && (
        ...
        href={"/admin"}
      >
        <MdSpaceDashboard size={20} fill="#fff" />
        <h5 className="pl-2 800px:block hidden font-Poppins dark:text-white text-black">DashBoard</h5>
      </Link>
      )
    }
      <div
